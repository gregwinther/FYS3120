...
\begin{tikzpicture}
	...
	% Particle 2
	\draw[->, thick, color=blue] (0,0)--(1,3.2) node[right]{\small{2}};
	
	% Photon
	\draw[->, thick, color=photon] (0,0)--(4, 4) node[left]{\small{$\gamma$}};
	
	% Source
	\draw[->, thick, color=source] (0,0)--(0, 2) node[left]{\small{Source}};
